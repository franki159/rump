<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="felicidades.aspx.cs" Inherits="PRESENTACION.felicidades" %>
...
<head>
    ...
    <!-- Title -->
    <title>RUMP Perú::Felicidades</title>
...
<div style="padding-left: 1.5rem;padding-right: 1.5rem;">
        ...
        <div class="row justify-content-center">
            ...
            <div class="wrapper text-center"><h1>¡FELICIDADES!</h1></div> 
                        <p>&nbsp;</p>
            <div class="sub-wrapper">Ganaste un cupón de 83%</div>
            <div class="sub-wrapper">de descuento</div>
                        <p>&nbsp;</p>
            <div class="cod-promocion">Por favor espere...</div>
        </div>
    </div>
                </div>
    </div>
    ...
    <script src="js/felicidades.js"></script>
</body>
</html>
