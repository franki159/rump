...
<body id="body">
    ...
    <header id="header">
        <div class="container">
            ...
            <div id="logo" class="pull-left">
                <a href="/">
                    <img src="public/front_estilos/img/worldpetsperu_logo.png" alt="World Pets Perú" title="World Pets Perú" /></a>
            </div>
  ...
  ============================-->
        ...
        <div class="container" style="margin-top: 40px;">
            ...
            <div class="row" style="padding: 10px;">
                ...
                <h6 style="margin-top: 30px; color: #5F1A0B; font-family: 'Raleway'">
                    <strong>&copy; 2019. Todos los Derechos Reservados.
                    </strong>
                </h6>
            </div>
        </div>
    ...
    <script async defer src="https://maps.googleapis.com/maps/api/js?key=AIzaSyAMpJ4QtIrcgHEjhiyDhzAh4q5G7yIyzgg" type="text/javascript"></script>
    ...
    <script src="public/front_estilos/lib/gmap3/gmap3.min.js"></script>
