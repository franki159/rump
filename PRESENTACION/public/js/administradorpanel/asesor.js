...
$(function ()
{
    ...
    function obtenerAsesores() {
        var data = {};
        var respuesta=peticion(data,'obtenerAsesores','/usuario/');
        ...
        if (resultado != null) {
            for (var i=0; i<resultado.length; i++) {
                ...
                buttonActualizar.attr('data-toogle', 'modal');
                buttonActualizar.attr('data-target', '#modalActualizarUsuario');
    ...
    $('#confirmarCrearAsesor').on("click", function ()
    {
        ...
        var respuesta = peticion(data, 'crearUsuarioAsesor');
        var resultado=respuesta.resultado;
        if (resultado) {
            alert(respuesta.mensaje);
    ...
    $('#confirmarActualizarUsuario').on("click", function ()
    {
        ...
        var data = {id:id, email:email, password:password, nombre:nombre};
