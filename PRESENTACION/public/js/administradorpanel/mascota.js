...
$(function ()
{
    ...
    function actualizarMascota() {
        ...
        var mascota_domicilio_id = $('#mascota_domicilio_id').val();
        ...
        var foto = cargarFoto();
        var mascotaFamilia = [{id: mascota_familia_padre_id, familiar: nombre_padre, dni: dni_padre, telefono: telefono_padre, tipo: "padre"},
            {id: mascota_familia_madre_id, familiar: nombre_madre, dni: dni_madre, telefono: telefono_madre, tipo: "madre"}];
        ...
        var data = {id: id, nombre: nombre, apellido: apellido, sexo: sexo, tamano: tamano, color: color,
            ...
            mascotaSalud: mascotaSalud, mascotaFamilia: mascotaFamilia
        };
        var mascotaGaleria = new Array();
        if(foto != null) {
            var galeria={foto: foto};
            mascotaGaleria.push(galeria);
            data['mascotaGaleria']=mascotaGaleria;
        }
