...
$(function ()
{
    ...
    function obtenerRazasMascota() {
        ...
        if (resultado != null) {
            for (var i = 0; i < resultado.length; i++) {
                var opcion = $('<option>', {text: resultado[i].tipo, val: resultado[i].tipo})
    ...
    $("#mascota_tipo_id").on("change", function () {
        obtenerRazasMascota();
    });
    ...
    $("#obtenerUsuario").on("click", function () {
        var email = $('#email').val();
        var data = {email: email};
        var respuesta = peticion(data, 'obtenerUsuarioParam1', '/usuario/');
        var resultado=respuesta.resultado;
        if (resultado != null) {
